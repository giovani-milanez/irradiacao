...
export default function ViewSessionsPage() {
  ...
  const GeralComponent = () => {
    return (<div className="mb-6">
      <div className="flex space-x-2 items-center mb-4">
        <h2 className="text-xl font-semibold">Lista nomes Irradiacao Geral ({data?.patients_count})</h2>
  ...
  const IntensiveComponent = () => {
    ...
    return (<div className="mb-6">
      <div className="flex space-x-2 items-center mb-4">
        <h2 className="text-xl font-semibold">Lista nomes Irradiacao Intensiva ({data?.uti_count})</h2>
      ...
      <div className="space-y-4">
        <div className={`grid grid-cols-${groups} gap-x-30 gap-y-4 mb-6`}>
  ...
  const LocalComponent = () => {
    return (<div className="flex justify-center space-x-4 mt-15">
      <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="#323232" stroke-width="2"></path> <path d="M12 3.05554C14.455 5.25282 16 8.44597 16 12C16 15.554 14.455 18.7471 12 20.9444" stroke="#323232" stroke-width="2" stroke-linecap="round"></path> <path d="M12.0625 21C9.57126 18.8012 8 15.5841 8 12C8 8.41592 9.57126 5.19883 12.0625 3" stroke="#323232" stroke-width="2" stroke-linecap="round"></path> <path d="M3 12H21" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
      <h2 className="text-2xl font-bold text-black dark:text-white sm:text-title-xl2">{data?.place}</h2>
    </div>)
  }
  ...
  const MembersComponent = () => {
    return (<div className="mb-6">
      <div className="flex space-x-2 items-center mb-4">
        <h2 className="text-xl font-semibold">Lista de Membros da Comunidade ({members?.length})</h2>
      </div>
      <div className="">
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-2">
          {members?.map((member) => (
